...
Node client1 = new Node("config_client1.txt");
Console.WriteLine("Client 1 iniciado.");
...
if (optionOrder == 1)
{
    ...
    while (true)
    {
        ...
        if (optionAction == 1)
        {
            ...
            eventMessage.IdClient = client1.id;
            ...
            client1.Send(0, serializedObject);

            string serializedEvent = "";
            client1.Receive(ref serializedEvent);
...
else
{
    ...
    while (true)
    {
        ...
        if (optionAction == 1)
        {
            ...
            client1.Broadcast(serializedObject);
